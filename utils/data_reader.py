...
def read_langs(vocab):
    ...
    train_context = np.load('dataset/sys_dialog_texts.train.npy',allow_pickle=True)
    train_target = np.load('dataset/sys_target_texts.train.npy',allow_pickle=True)
    train_emotion = np.load('dataset/sys_emotion_texts.train.npy',allow_pickle=True)
    train_situation = np.load('dataset/sys_situation_texts.train.npy',allow_pickle=True)

    dev_context = np.load('dataset/sys_dialog_texts.dev.npy',allow_pickle=True)
    dev_target = np.load('dataset/sys_target_texts.dev.npy',allow_pickle=True)
    dev_emotion = np.load('dataset/sys_emotion_texts.dev.npy',allow_pickle=True)
    dev_situation = np.load('dataset/sys_situation_texts.dev.npy',allow_pickle=True)
    
    test_context = np.load('dataset/sys_dialog_texts.test.npy',allow_pickle=True)
    test_target = np.load('dataset/sys_target_texts.test.npy',allow_pickle=True)
    test_emotion = np.load('dataset/sys_emotion_texts.test.npy',allow_pickle=True)
    test_situation = np.load('dataset/sys_situation_texts.test.npy',allow_pickle=True)
...
def load_dataset():
    if(os.path.exists('dataset/dataset_preproc.p')):
        ...
        with open('dataset/dataset_preproc.p', "wb") as f:
